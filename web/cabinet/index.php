...
checklogin();
if(empty($_SESSION['investname'])){
	$_SESSION['investname']="";
}
if(empty($_SESSION['invest_type'])){
	$_SESSION['invest_type']=0;
}
?><!DOCTYPE html>
<html>
<head>
...
<div class="header_panel"><h1 align="center"><?=$lng_title_main?> (<?=$_SESSION['investname']?>)</h1></div>
<div>
<div class="left_panel"><table width="100%" border="0" cellpadding="2" cellspacing="2" bordercolor="#990000" bgcolor="#FFFFFF">
        ...
        <tr>
          <td><a class="button" href="referral.i"><?=$lng_title_referral?></a></td>
        </tr>
        <tr>
	...
	<?php if(isset($_GET['page'])){
			switch($_GET['page']){
				...
				case 'banners.i': include('banners.php');
					break;
				case 'referral.i': include('referral.php');
					break;
